...
def get_10y_yield() -> float | None:
    ...
    Used for equity risk premium (ERP) calculation: forward earnings yield – DGS10/100.
    Returns None when FRED_API_KEY is unset or network fails.
    """
    data = fetch_series("DGS10")
    if not data:
        return None
    return data[-1][1]
