...
| `residual_reversal` | Market-excess 5d return (stock − SPY) ≤ −7% **and** sector-excess 5d return (stock − own-sector EW peers) ≤ −7% (v1.144 conjunct — filters sector-rout beta; fail-open when sector unknown) — idiosyncratic laggard reverting over 1–3d; blocked in STRESS_RISK_OFF and HIGH_VOL_DOWNTREND (2026-07 workshop, N1) | 3 days |
