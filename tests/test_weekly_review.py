...
class TestRunWeeklyReview(unittest.TestCase):
    ...
    def test_counterfactual_telemetry_failure_does_not_break_review(self):
        from analysis.weekly_review import run_weekly_review
        ...
        with (
            ...
            patch("analysis.weekly_review.anthropic.Anthropic") as mock_anthropic,
            patch(
                "analysis.weekly_review.horizon_counterfactuals",
                side_effect=RuntimeError("boom"),
            ),
        ):
            mock_anthropic.return_value.messages.create.return_value = self._mock_ai_response(
    ...
    def test_specialization_telemetry_failure_does_not_break_review(self):
        from analysis.weekly_review import run_weekly_review
        ...
        with (
            ...
            patch("analysis.weekly_review.anthropic.Anthropic") as mock_anthropic,
            patch(
                "analysis.weekly_review.ai_edge_by_slice",
                side_effect=RuntimeError("boom"),
            ),
        ):
            mock_anthropic.return_value.messages.create.return_value = self._mock_ai_response(
    ...
    def test_case_memory_telemetry_failure_does_not_break_review(self):
        from analysis.weekly_review import run_weekly_review
        ...
        with (
            ...
            patch("analysis.weekly_review.anthropic.Anthropic") as mock_anthropic,
            patch(
                "analysis.weekly_review.evaluate_case_memory",
                side_effect=RuntimeError("boom"),
            ),
        ):
            mock_anthropic.return_value.messages.create.return_value = self._mock_ai_response(
    ...
    def test_authoring_failure_does_not_break_review(self):
        from analysis.weekly_review import run_weekly_review
        ...
        with (
            ...
            patch("analysis.weekly_review.anthropic.Anthropic") as mock_anthropic,
            patch("analysis.weekly_review.run_authoring", side_effect=RuntimeError("boom")),
        ):
            mock_anthropic.return_value.messages.create.return_value = self._mock_ai_response(
                fake_review
            )
